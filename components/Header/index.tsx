      ...
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0 lg:flex items-center justify-between relative">
        ...
        >
          ...
          <div className="flex items-center gap-6 mt-7 lg:mt-0">
            ...
            <Link legacyBehavior
              href="https://github.com/imrulkayessifat"
            ...
            <Link legacyBehavior
              href="https://www.linkedin.com/in/imrul-kayes-sifat-27809b281"
              className="flex items-center justify-center bg-primary hover:bg-primaryho ease-in-out duration-300 text-white text-regular rounded py-2.5 px-3.5"
            >
