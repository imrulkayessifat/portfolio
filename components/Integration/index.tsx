      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `Skills`,
              subtitle: `Build application with tech stacks`,
              description: `Combination of programming languages, frameworks, libraries, and tools that i use to build the user interface and user experience of a web application`,
            }}
          />
            ...
            >
              <div className="inline-block rounded-[10px] shadow-solid-7 bg-white dark:bg-btndark p-4.5">
                <Image
                  width={50}
                  height={50}
                  src="./images/shape/typescript.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
